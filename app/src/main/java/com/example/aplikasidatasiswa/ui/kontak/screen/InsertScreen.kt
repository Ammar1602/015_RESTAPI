package com.example.aplikasidatasiswa.ui.kontak.screen
...
import com.example.aplikasidatasiswa.ui.kontak.viewmodel.InsertUiEvent
import com.example.aplikasidatasiswa.ui.kontak.viewmodel.InsertUiState
...
fun EntryKontakScreen(
    ...
    Scaffold(
        ...
        EntryKontakBody(
            ...
            onSiswaValueChallenge = viewModel::updateInsertKontakState,
            onSaveClick = {
...
fun EntryKontakBody(
    ...
    onSiswaValueChallenge: (InsertUiEvent) -> Unit,
    onSaveClick: () -> Unit,
    modifier: Modifier = Modifier
){
    Column(
        ...
        FormInputSiswa(
            insertUiEvent = insertUiState.inserUiEvent,
            onValueChange = onSiswaValueChallenge,
